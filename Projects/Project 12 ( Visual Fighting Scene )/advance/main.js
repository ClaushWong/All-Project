...
var counter1;
var counter2;
var attr = [ fire , water , terra , none ];
...
enemy1.baseDef = 200;
enemy1.mgkDef = 300;
enemy1.stats = attr[Math.floor( Math.random() * 4 )];
enemy1.condition = [];
...
enemy2.baseDef = 200;
enemy2.mgkDef = 300;
enemy2.stats = attr[Math.floor( Math.random() * 4 )];
enemy2.condition = [];
...
enemy3.baseDef = 200;
enemy3.mgkDef = 300;
enemy3.stats = attr[Math.floor( Math.random() * 4 )];
enemy3.condition = [];
